...
class CreateTemporaryMaterialProduct extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
		 Schema::create('temporary_material_products', function (Blueprint $table) {
			$table->increments('id');
    ...
    {
         Schema::dropIfExists('temporary_material_products');
    }
}
