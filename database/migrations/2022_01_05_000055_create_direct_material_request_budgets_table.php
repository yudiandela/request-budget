...
class CreateDirectMaterialRequestBudgetsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('direct_material_request_budgets', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('direct_material_request_budgets');
    }
}
