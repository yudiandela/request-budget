...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Master SAP Vendor</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('vendor.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create SAP Vendor</a>
        </div><!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-vendor">
                    <thead>
                        <tr>
                            <th>Vendor Code</th>
                            <th>Vendor SName</th>
...
<script src="{{ url('assets/js/pages/vendor.js') }}"></script>
@endpush