...
<div class="container">
    <div class="row">
        <div class="col-xs-12">
            <div class="page-title-box">
                <h4 class="page-title">Master Period</h4>
    ...
    <div class="row">
        <div class="col-sm-4">
             <a href="{{ route('period.create') }}" class="btn btn-inverse btn-bordered waves-effect waves-light m-b-20"><i class="mdi mdi-plus"></i> Create Period</a>
        </div><!-- end col -->
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-box">
                <table class="table m-0 table-colored table-inverse" id="table-period">
                    <thead>
                        <tr>
                            <th>Name</th>
                            <th>Value</th>
...
<script src="{{ url('assets/js/pages/period.js') }}"></script>
@endpush