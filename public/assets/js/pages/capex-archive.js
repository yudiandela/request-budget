...
if(src_dest == 'src'){ 
	tbl_url = SITE_URL + '/capex/archive/ajaxsource';
}else{
	tbl_url = SITE_URL + '/capex/archive/ajaxdest'; 
}
...
function moveArchive() {
	...
	$.getJSON(SITE_URL+"/capex/get_archive", data, function( data ) {
...
function undoArchive() {
	...
	$.getJSON(SITE_URL+"/capex/undo_archive", data, function( data ) {
